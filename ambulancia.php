...
<?php
	...
	if ($enviado != ""){
	    ...
	    Insere_Emergencia($_POST["CPF"], $_POST["nome"], $_POST["RG"], $_POST["telefone"], $_POST["logradouro"], $_POST["numero"], $_POST["bairro"], $_POST["complemento"], $_POST["cidade"], $_POST["estado"], 0, $_POST["descricao"]);
	}
?>
<body>
	<div id="wrap">
		    ...
		    <table border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        <td>
		            ...
		            <textarea name="descricao" id="descricao" rows="10" cols="50" required placeholder="Descrição"></textarea>
